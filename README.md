...
File Location: src/cp1ms2 | CP1MS2.java, motorph_data.csv
...
Confirms employee IDs by checking them against the company’s official records.

⏰ Time Tracking
Records and processes attendance logs, including employee check-in and check-out times.

💰 Salary Calculation
Calculates weekly pay based on the employee’s total hours worked and hourly rate.
